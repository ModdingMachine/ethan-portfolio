  ...
  useEffect(() => {
    const generateBio = async () => {
      try {
        ...
        // Parse the markdown response and split into paragraphs
        const parsedResponse = parseMarkdown(response);
        // Remove HTML tags and split by double line breaks to get paragraphs
        const textContent = parsedResponse.replace(/<[^>]*>/g, '');
