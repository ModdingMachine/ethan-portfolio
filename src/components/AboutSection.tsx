    ...
    const generateBio = async () => {
      try {
        ...
        const response = await sendChatMessage(
          "Generate a 3 paragraph bio for Ethan's website, two sentences per paragraph, note that the bio was generated by ai and is different every time the website loads. Do not include any intro outro or commentary, just the bio."
        );
